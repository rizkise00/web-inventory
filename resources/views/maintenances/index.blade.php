        ...
        <div class="mb-6">
            <form action="{{ route('maintenances.index') }}" method="GET" class="space-y-3">
                ...
                <div class="flex flex-wrap gap-2 items-center justify-end">
                    ...
                    <button type="button"
                        data-export-btn
                        data-excel-url="{{ route('maintenances.export', request()->only(['search', 'status', 'date_from', 'date_to'])) }}"
                        data-pdf-url="{{ route('maintenances.export', array_merge(request()->only(['search', 'status', 'date_from', 'date_to']), ['format' => 'pdf'])) }}"
