        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <form method="POST" action="{{ isset($maintenance) ? route('maintenances.update', $maintenance) : route('maintenances.store') }}">
                ...
                <div class="flex items-center justify-end">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Update Maintenance</button>
                </div>
            </form>
        </div>
    </div>
