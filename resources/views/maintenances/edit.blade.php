...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Edit Maintenance</h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form method="POST" action="{{ route('maintenances.update', $maintenance) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="quantity" id="quantity" value="{{ old('quantity', $maintenance->quantity) }}" required min="1"
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="3"
                        ...
                        placeholder="Maintenance details...">{{ old('description', $maintenance->description) }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
