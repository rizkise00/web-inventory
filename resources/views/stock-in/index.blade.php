        ...
        <div class="mb-6">
            <form action="{{ route('stock-in.index') }}" method="GET" class="space-y-3">
                ...
                <div class="flex flex-wrap gap-2 items-center justify-end">
                    ...
                    @endif
                    <a href="{{ route('stock-in.export', request()->only(['item_name', 'user_name', 'date_from', 'date_to'])) }}" class="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold py-2 px-5 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center text-sm">
