            ...
            <form action="{{ route('stock-in.update', $stockIn) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="item_id" id="item_id" required
                        ...
                        @foreach($items as $item)
                            <option value="{{ $item->id }}" data-price="{{ $item->price }}" {{ old('item_id', $stockIn->item_id) == $item->id ? 'selected' : '' }}>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="notes" id="notes" rows="3"
                        ...
                        placeholder="Additional information...">{{ old('notes', $stockIn->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
