        ...
        <div class="mb-6">
            <form action="{{ route('categories.index') }}" method="GET" class="space-y-3">
                ...
                <div class="flex flex-wrap gap-2 items-center justify-end">
                    ...
                    <button type="button"
                        data-export-btn
                        data-excel-url="{{ route('categories.export', request()->only(['search', 'date_from', 'date_to'])) }}"
                        data-pdf-url="{{ route('categories.export', array_merge(request()->only(['search', 'date_from', 'date_to']), ['format' => 'pdf'])) }}"
