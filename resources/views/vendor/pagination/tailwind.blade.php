            ...
            <div>
                <span class="inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
                    ...
                    @foreach ($elements as $element)
                        ...
                        <span class="inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-gray-200 border border-gray-300 cursor-default leading-5 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 !bg-blue-600 !border-blue-600 !text-white">{{ $page }}</span>
                                    </span>
                                @else
