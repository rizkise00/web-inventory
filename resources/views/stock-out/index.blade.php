    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                ...
                <p class="text-gray-600">Kelola data outgoing stock data</p>
            </div>
                    ...
                    <tr class="hover:bg-green-50 transition-colors duration-200">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <span class="font-medium text-gray-800">{{ $stockOut->item->name ?? 'Unknown Item' }}</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-gray-600">{{ $stockOut->created_at->format('Y-m-d H:i') }}</td>
